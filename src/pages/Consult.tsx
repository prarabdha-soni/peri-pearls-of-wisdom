      ...
      <div className="mx-auto max-w-3xl">
        ...
        <Card className="mb-8 border-border bg-card p-8">
          ...
          <p className="text-center text-muted-foreground mb-8">
            Chat with us directly on WhatsApp for instant consultation and support
          </p>
          <div className="flex justify-center">
            <Button 
              size="lg" 
              className="w-full max-w-md rounded-full shadow-soft hover:shadow-lg transition-all bg-[#25D366] hover:bg-[#20BA5A] text-white"
              asChild
            >
              <a
